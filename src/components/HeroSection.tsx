  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-herb-green to-herb-green-light overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        {/* Tagline */}
        <p className="font-playfair text-xl sm:text-2xl lg:text-3xl text-herb-cream mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          Pure Skin. Pure Roots. Pure You.
        </p>
        
        {/* Description */}
        <p className="font-inter text-lg sm:text-xl text-herb-cream/90 mb-12 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.4s' }}>
          100% chemical-free Tamil herbal skincare inspired by traditional Paatti remedies. 
          Handmade with love for naturally glowing skin.
        </p>
        ...
        <div className="absolute bottom-32 right-16 w-4 h-4 bg-herb-rose rounded-full opacity-60 animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/3 right-8 w-3 h-3 bg-herb-cream rounded-full opacity-60 animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
    </section>
  );
};
